...
// - META_ACCESS_TOKEN (opcional, para Facebook CAPI)
// - META_PIXEL_ID (padrão: 958954899926961)
// - META_API_VERSION (padrão: v18.0)
...
module.exports = async (req, res) => {
  ...
  // Facebook CAPI - InitiateCheckout (server-side, em paralelo com a criação do PIX)
  trackInitiateCheckout({ name, email }, { value: 30.00 }).catch(e => {
